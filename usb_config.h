...
#define HUSB_CONFIG_EPS       1 // Include EP0 in this count
#define HUSB_SUPPORTS_SLEEP   0
#define HUSB_HID_INTERFACES   1
#define HUSB_HID_USER_REPORTS 1
#define HUSB_IO_PROFILE       1
#define HUSB_BULK_USER_REPORTS 0
...
static const uint8_t device_qualifier_descriptor[] = {
    0x0A,                       // bLength: Length of descriptor in bytes
    0x06,                       // bDescriptorType: DEVICE QUALIFIER descriptor type
    0x00, 0x02,                 // bcdUSB: USB specification release number (2.0)
    0x00,                       // bDeviceClass: Class code (0x00 means defined in interface descriptor)
    ...
    0x00                        // bReserved: Reserved, must be 0
};

#define STR_MANUFACTURER u"Alexander Mandera"
#define STR_PRODUCT      u"USB Custom Bootloader"
...
const static struct descriptor_list_struct {
    ...
    {0x00000600, device_qualifier_descriptor, sizeof(device_qualifier_descriptor)},
